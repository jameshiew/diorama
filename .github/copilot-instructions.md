...
- avoid using | characters withing quoted strings e.g. do `grep -e warning -e error`; do not do `grep "warning|error"`
  Logging & Progress
...
• Reuse dependencies from existing Cargo.tomls if possible
